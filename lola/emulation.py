...
def encode_traj(
    ...
    **kwargs,
    ...
    if chunk_size is None:
        ...
        z = torch.cat([autoencoder.encode(xi, **kwargs) for xi in torch.split(x, chunk_size)])
...
def decode_traj(
    ...
    **kwargs,
    ...
    if chunk_size is None:
        ...
        x = torch.cat([autoencoder.decode(zi, **kwargs) for zi in torch.split(z, chunk_size)])
