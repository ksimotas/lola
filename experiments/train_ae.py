...
def train(runid: str, cfg: DictConfig):
    ...
    from lola.autoencoder import AutoEncoderLoss, get_autoencoder
    from lola.data import field_preprocess, get_dataloader, get_well_inputs, get_well_multi_dataset
