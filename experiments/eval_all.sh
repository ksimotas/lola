...
runs=(
    ...
    "$HOME/ceph/lola/runs/ae/yw23shfh_euler_all_dcae_f32c32_large"
    ...
    "$HOME/ceph/lola/runs/ae/a4fulyxg_rayleigh_benard_dcae_f32c32_large"
    ...
    "$HOME/ceph/lola/runs/dm/6mnf6vle_euler_all_f32c32_vit_large"
    ...
    "$HOME/ceph/lola/runs/dm/zt8nzq37_rayleigh_benard_f32c32_vit_large"
    ...
    "$HOME/ceph/lola/runs/sm/9a2wk0hd_euler_all_f32c32_vit_large"
    ...
    "$HOME/ceph/lola/runs/sm/fa6jeugp_rayleigh_benard_f32c32_vit_large"
